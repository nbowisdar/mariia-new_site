        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Професійна психологічна допомога для тих, хто шукає підтримку та розуміння.
            </p>
          </div>
          ...
          <div>
            ...
            <nav className="flex flex-col gap-2">
              ...
              <NavLink to="/appointment" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                Записатися
              </NavLink>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <a href="mailto:maria@example.com" className="flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors">
                <Mail size={16} />
                maria@example.com
              </a>
              <a href="tel:+380123456789" className="flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors">
                <Phone size={16} />
                +380 12 345 67 89
              </a>
